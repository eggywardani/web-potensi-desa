...
$pertanian = query("SELECT * FROM pertanian ORDER BY id DESC");
...
if (isset($_POST['update'])) {
    ...
    $updatedata = mysqli_query($conn, "update pertanian set wilayah = '$wilayah',luas=$luas,  status='$status',prospek='$prospek' where id='$id'");

    //cek apakah berhasil
    if ($updatedata) {

        echo " <meta http-equiv='refresh' content='1; url= pertanian.php'/>  ";
    } else {
        echo "<meta http-equiv='refresh' content='1; url= pertanian.php'/> ";
    }
};
if (isset($_POST['hapus'])) {
    ...
    $delete = mysqli_query($conn, "delete from pertanian where id='$id'");
    ...
    if ($delete) {
        ...
        echo "
            <meta http-equiv='refresh' content='1; url= pertanian.php'/>  ";
    } else {
        echo "
             <meta http-equiv='refresh' content='1; url= pertanian.php'/> ";
    }
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="tambah_pertanian.php" method="post">

                            <div class="form-group">
                                <label>Wilayah</label>
                                <input name="wilayah" type="text" class="form-control" placeholder="wilayah" required>
                            </div>
                            <div class="form-group">
                                <label>Luas</label>
                            ...
                            <div class="form-group">
                                <label>Prospek</label>
                                <input name="prospek" type="text" class="form-control" placeholder="prospek" required>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="card demo-icons">
                        ...
                        <div class="card-body all-icons">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form method="post">
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Data <?php echo $row['wilayah'] ?> - <?php echo $row['prospek'] ?> </h4>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form method="post">
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Ubah Data <?php echo $row['wilayah'] ?>-<?php echo $row['prospek'] ?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Wilayah</label>
                                                                <input name="wilayah" type="text" class="form-control" placeholder="wilayah" required value="<?php echo $row['wilayah'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Luas</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Prospek</label>
                                                                <input name="prospek" type="text" class="form-control" placeholder="prospek" required value="<?php echo $row['prospek'] ?>">
                                                            </div>
                            ...
                            <a class="btn btn-primary text-white" href="export_pertanian.php" role="button">Export Data</a>
                        </div>
                    </div>
                </div>
            </div>
