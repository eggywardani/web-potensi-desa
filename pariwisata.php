...
$pariwisata = query("SELECT * FROM pariwisata ORDER BY id DESC");
...
if (isset($_POST['update'])) {
    ...
    $updatedata = mysqli_query($conn, "update pariwisata set lokasi = '$lokasi',luas=$luas, jenis='$jenis', status='$status' where id='$id'");

    //cek apakah berhasil
    if ($updatedata) {

        echo " <meta http-equiv='refresh' content='1; url= pariwisata.php'/>  ";
    } else {
        echo "<meta http-equiv='refresh' content='1; url= pariwisata.php'/> ";
    }
};
if (isset($_POST['hapus'])) {
    ...
    $delete = mysqli_query($conn, "delete from pariwisata where id='$id'");
    ...
    if ($delete) {
        ...
        echo "
            <meta http-equiv='refresh' content='1; url= pariwisata.php'/>  ";
    } else {
        echo "
             <meta http-equiv='refresh' content='1; url= pariwisata.php'/> ";
    }
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="tambah_pariwisata.php" method="post">
                ...
                <div class="col-md-12">
                    <div class="card demo-icons">
                        ...
                        <div class="card-body all-icons">
                            ...
                            <a class="btn btn-primary text-white" href="export_pariwisata.php" role="button">Export Data</a>
                        </div>
                    </div>
                </div>
            </div>
